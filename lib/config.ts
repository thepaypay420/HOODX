...
export const LIVE_FACTORY_ADDR = "0xB6CdCA31fC5EDAb747d69Ec6D7e6d251De8DE03a";
/** Superseded FAANGX test factories — vaults had USDG bridge dust. */
export const SUPERSEDED_FAANGX_FACTORY_ADDR = "0x67427270Dd489822d6348C8c68f7545B0f3c27eE";
export const SUPERSEDED_FAANGX_FACTORY_ADDR_2 = "0x2eDfB7b9A46A29DD5f932aa15a07a79d0Cae7c83";
export const SUPERSEDED_FAANGX_FACTORY_ADDR_3 = "0x67427270Dd489822d6348C8c68f7545B0f3c27eE";
/** HoodxIndex implementation — EIP-1167 clones (e.g. $696X) point here. */
export const INDEX_IMPL_ADDR = "0x7B16e89a210984B349c5A69e1c9C31f17075117E";
export const SWAP_LOGIC_ADDR = "0x61a32A64A9B316238D2E0F976b134cD0a0e623CA";
...
export const SUPERSEDED_FAANGX_VAULT_ADDR_3 = "0x011204DB4CEb6D8D9c972da55269927C6738785b";
/** Canonical live FAANGX — set after `scripts/ready_faangx.py` proves enter/exit. */
export const SAFE_FAANGX_VAULT_ADDR = "0x037c116d7C09Ed4D2733Eb628488ab9c0394353f" as `0x${string}` | "";
...
const FAANGX_DENY = [
  ...
  SUPERSEDED_FAANGX_VAULT_ADDR_3,
];
...
export const FACTORY = liveOr(
  ...
  [
    ...
    SUPERSEDED_FAANGX_FACTORY_ADDR_3,
  ],
) as `0x${string}` | "";
