...
import {VaultV2Test, TestTokenV2, TestWethV2, TestExecutorV2, TestOracleV2, TestPolicyV2} from "../v2/VaultV2.t.sol";
import {HoodxIndexV3} from "../../contracts/v3/HoodxIndexV3.sol";
import {Clones} from "@openzeppelin/contracts/proxy/Clones.sol";

contract VaultHandlerV3 is Test {
    HoodxIndexV3 public vault;
    TestWethV2 public w;
    ...
    constructor() {
        ...
        HoodxIndexV3 impl = new HoodxIndexV3(address(p), address(0));
        vault = HoodxIndexV3(payable(Clones.clone(address(impl))));
...
contract VaultInvariantV3Test is StdInvariant, Test {
    VaultHandlerV3 h;

    function setUp() public {
        h = new VaultHandlerV3();
