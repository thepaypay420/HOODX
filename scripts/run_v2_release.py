...
def main():
    ...
    p.add_argument("stage",choices=["canary-deploy","canary-smoke","production","recover"])
    ...
    target={"canary-deploy":"DeployV2","canary-smoke":"CanaryV2","production":"DeployV2","recover":"RecoverCanaryV2"}[a.stage]
